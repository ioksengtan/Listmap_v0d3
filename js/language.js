...
(function (root) {
  ...
  var ui = {
    'zh-TW': {
      ...
      'visitor.blogLead': '目前對外公開四篇。內部測試與未校正座標的故事不放在這裡。',
      ...
      'visitor.aboutPublic': '現在對外公開四篇：〈新竹牛肉麵五選〉、〈陽明山：住一晚，走兩天〉、〈東京桌上遊戲市集：怎麼住幕張、哪天充電（2026 秋）〉、〈南特造船廠裡，有隻會走路的大象〉。',
    ...
    en: {
      ...
      'visitor.blogLead': 'Four stories are public. Internal tests and uncorrected coordinates stay off this page.',
      ...
      'visitor.aboutPublic': 'Four stories are public: Hsinchu beef noodle five, Yangmingshan stay-and-hike, Tokyo tabletop market in Makuhari, and a walking elephant in the Nantes shipyard.',
