...
(function (root) {
  ...
  var ui = {
    'zh-TW': {
      ...
      'visitor.blogLead': '目前對外公開八篇。內部測試與未校正座標的故事不放在這裡。',
      ...
      'visitor.aboutPublic': '現在對外公開八篇：〈新竹牛肉麵五選〉、〈陽明山：住一晚，走兩天〉、〈東京桌上遊戲市集：怎麼住幕張、哪天充電（2026 秋）〉、〈南特造船廠裡，有隻會走路的大象〉、〈福隆：住一晚，騎舊草嶺〉、〈秋芳洞：地下十七度，電梯上去是台地〉、〈越生：黒山園釣烤，順路三座瀑布〉、〈瑞士：纜車一路連到馬特洪峰〉。',
    ...
    en: {
      ...
      'visitor.blogLead': 'Eight stories are public. Internal tests and uncorrected coordinates stay off this page.',
      ...
      'visitor.aboutPublic': 'Eight stories are public: Hsinchu beef noodle five, Yangmingshan stay-and-hike, Tokyo tabletop market in Makuhari, a walking elephant in the Nantes shipyard, Fulong: one night, bike Old Caoling, Akiyoshido: seventeen degrees underground, elevator up to the plateau, Ogose: Kuroyamaen fish-and-grill, three waterfalls on the way, and Switzerland: cable cars all the way to the Matterhorn.',
