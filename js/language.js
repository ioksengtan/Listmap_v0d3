...
(function (root) {
  ...
  var ui = {
    'zh-TW': {
      ...
      'visitor.homeLead': '每個圖釘背後都有一段路——走過的，或還沒走的。這裡放的是我自己的。',
      'visitor.exploreMap': '探索地圖',
      'visitor.allStories': '瀏覽全部故事',
      'visitor.latestStories': '最新故事',
      'visitor.preview': '地圖',
      'visitor.previewMap': '在地圖預覽',
      'visitor.blogIndexLead': '依地點、標題或標籤尋找故事；選擇故事後，文章與地圖會一起移動。',
      'visitor.searchStories': '搜尋故事',
      'visitor.searchPlaceholder': '搜尋地點、標題或標籤',
      'visitor.filterAll': '全部',
      'visitor.filterVisited': '去過',
      'visitor.filterWishlist': '想去',
      'visitor.filterPerson': '人物',
      'visitor.resultCount': '符合條件：{count} 篇',
      'visitor.showMore': '顯示更多 {count} 篇',
      'visitor.publicStories': '公開故事',
      'visitor.readStory': '閱讀這則故事',
      'visitor.blogLead': '目前對外公開十六篇。內部測試與未校正座標的故事不放在這裡。',
      ...
      'visitor.aboutPublic': '現在對外公開十六篇：〈新竹牛肉麵五選〉、〈陽明山：住一晚，走兩天〉、〈東京桌上遊戲市集：怎麼住幕張、哪天充電（2026 秋）〉、〈南特造船廠裡，有隻會走路的大象〉、〈福隆：住一晚，騎舊草嶺〉、〈秋芳洞：地下十七度，電梯上去是台地〉、〈越生：黒山園釣烤，順路三座瀑布〉、〈河津：山側七座瀑布，海岸另半天〉、〈立山室堂：兩千四百五十公尺的平地〉、〈稲取赤尾：住一晚，看漁港與相模灣〉、〈瑞士：纜車一路連到馬特洪峰〉、〈北歐：渡輪串起的七天〉、〈日本粉雪三選：湯澤、留壽都、富良野〉、〈雙灣：淺水灣騎到白沙灣〉、〈2027關西春季：甲子園、相撲、賞櫻與登山〉、〈台東活水湖：住一晚，安靜練開放水域〉。',
      'visitor.read1024': '閱讀新竹牛肉麵五選',
      'visitor.read1025': '閱讀陽明山：住一晚，走兩天',
      'visitor.read1027': '閱讀東京桌上遊戲市集：怎麼住幕張',
      'visitor.read1028': '閱讀南特造船廠裡，有隻會走路的大象',
      'visitor.read1029': '閱讀福隆：住一晚，騎舊草嶺',
      'visitor.read1030': '閱讀秋芳洞：地下十七度，電梯上去是台地',
      'visitor.read1031': '閱讀越生：黒山園釣烤，順路三座瀑布',
      'visitor.read1032': '閱讀河津：山側七座瀑布，海岸另半天',
      'visitor.read1033': '閱讀立山室堂：兩千四百五十公尺的平地',
      'visitor.read1034': '閱讀稲取赤尾：住一晚，看漁港與相模灣',
      'visitor.read100023': '閱讀瑞士：纜車一路連到馬特洪峰',
      'visitor.read100024': '閱讀北歐：渡輪串起的七天',
      'visitor.read100026': '閱讀日本粉雪三選：湯澤、留壽都、富良野',
      'visitor.read100030': '閱讀雙灣：淺水灣騎到白沙灣',
      'visitor.read100032': '閱讀2027關西春季：甲子園、相撲、賞櫻與登山',
      'visitor.read100074': '閱讀台東活水湖：住一晚，安靜練開放水域',
      'nav.findStories': '找故事',
      'nav.search': '搜尋',
    ...
    en: {
      ...
      'visitor.homeLead': 'Every pin holds a road — walked, or not yet. These are mine.',
      'visitor.exploreMap': 'Explore the map',
      'visitor.allStories': 'Browse all stories',
      'visitor.latestStories': 'Latest stories',
      'visitor.preview': 'Map',
      'visitor.previewMap': 'Preview on map',
      'visitor.blogIndexLead': 'Search by place, title, or tag. Open a story and the article moves with the map.',
      'visitor.searchStories': 'Search stories',
      'visitor.searchPlaceholder': 'Search places, titles, or tags',
      'visitor.filterAll': 'All',
      'visitor.filterVisited': 'Visited',
      'visitor.filterWishlist': 'Want to go',
      'visitor.filterPerson': 'People',
      'visitor.resultCount': '{count} stories',
      'visitor.showMore': 'Show {count} more',
      'visitor.publicStories': 'Public stories',
      'visitor.readStory': 'Read this story',
      'visitor.blogLead': 'Sixteen stories are public. Internal tests and uncorrected coordinates stay off this page.',
      ...
      'visitor.aboutPublic': 'Sixteen stories are public: Hsinchu beef noodle five, Yangmingshan stay-and-hike, Tokyo tabletop market in Makuhari, a walking elephant in the Nantes shipyard, Fulong: one night, bike Old Caoling, Akiyoshido: seventeen degrees underground, elevator up to the plateau, Ogose: Kuroyamaen fish-and-grill, three waterfalls on the way, Kawazu: seven waterfalls on the mountain side, the coast another half day, Tateyama Murodo: a plateau at two thousand four hundred and fifty metres, Inatori Akao: one night, looking at the fishing port and Sagami Bay, Switzerland: cable cars all the way to the Matterhorn, Scandinavia: seven days strung together by ferry, three powder picks in Japan: Yuzawa, Rusutsu, Furano, Shuangwan: ride from Qianshuiwan to Baishawan, Kansai spring 2027: Koshien, sumo, cherry blossoms, and hiking, and Taitung Huoshui Lake: stay one night, quietly practice open water.',
      'visitor.read1024': 'Read Hsinchu beef noodle five',
      'visitor.read1025': 'Read Yangmingshan: stay one night, walk two days',
      'visitor.read1027': 'Read Tokyo tabletop market: stay in Makuhari',
      'visitor.read1028': 'Read A walking elephant in the Nantes shipyard',
      'visitor.read1029': 'Read Fulong: one night, bike Old Caoling',
      'visitor.read1030': 'Read Akiyoshido: seventeen degrees underground, elevator up to the plateau',
      'visitor.read1031': 'Read Ogose: Kuroyamaen fish-and-grill, three waterfalls on the way',
      'visitor.read1032': 'Read Kawazu: seven waterfalls on the mountain side, the coast another half day',
      'visitor.read1033': 'Read Tateyama Murodo: a plateau at two thousand four hundred and fifty metres',
      'visitor.read1034': 'Read Inatori Akao: one night, looking at the fishing port and Sagami Bay',
      'visitor.read100023': 'Read Switzerland: cable cars all the way to the Matterhorn',
      'visitor.read100024': 'Read Scandinavia: seven days strung together by ferry',
      'visitor.read100026': 'Read three powder picks in Japan: Yuzawa, Rusutsu, Furano',
      'visitor.read100030': 'Read Shuangwan: ride from Qianshuiwan to Baishawan',
      'visitor.read100032': 'Read Kansai spring 2027: Koshien, sumo, cherry blossoms, and hiking',
      'visitor.read100074': 'Read Taitung Huoshui Lake: stay one night, quietly practice open water',
