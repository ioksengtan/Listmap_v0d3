...
(function (root) {
  ...
  var ui = {
    'zh-TW': {
      ...
      'visitor.aboutPublic': '現在對外公開三篇：〈新竹牛肉麵五選〉、〈陽明山：住一晚，走兩天〉、〈東京桌遊展怎麼住幕張、哪天充電（2026 秋）〉。',
      'visitor.read1024': '閱讀新竹牛肉麵五選',
      'visitor.read1025': '閱讀陽明山：住一晚，走兩天',
      'visitor.read1027': '閱讀東京桌遊展怎麼住幕張',
      'nav.findStories': '找故事',
      'nav.search': '搜尋',
    ...
    en: {
      ...
      'visitor.aboutPublic': 'Three stories are public: Hsinchu beef noodle five, Yangmingshan stay-and-hike, and Tokyo board-game fair in Makuhari.',
      'visitor.read1024': 'Read Hsinchu beef noodle five',
      'visitor.read1025': 'Read Yangmingshan: stay one night, walk two days',
      'visitor.read1027': 'Read Tokyo board-game fair: stay in Makuhari',
