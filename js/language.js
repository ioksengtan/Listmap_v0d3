...
(function (root) {
  ...
  var ui = {
    'zh-TW': {
      ...
      'visitor.blogLead': '目前對外公開十三篇。內部測試與未校正座標的故事不放在這裡。',
      ...
      'visitor.aboutPublic': '現在對外公開十三篇：〈新竹牛肉麵五選〉、〈陽明山：住一晚，走兩天〉、〈東京桌上遊戲市集：怎麼住幕張、哪天充電（2026 秋）〉、〈南特造船廠裡，有隻會走路的大象〉、〈福隆：住一晚，騎舊草嶺〉、〈秋芳洞：地下十七度，電梯上去是台地〉、〈越生：黒山園釣烤，順路三座瀑布〉、〈河津：山側七座瀑布，海岸另半天〉、〈立山室堂：兩千四百五十公尺的平地〉、〈稲取赤尾：住一晚，看漁港與相模灣〉、〈瑞士：纜車一路連到馬特洪峰〉、〈北歐：渡輪串起的七天〉、〈日本粉雪三選：湯澤、留壽都、富良野〉。',
    ...
    en: {
      ...
      'visitor.blogLead': 'Thirteen stories are public. Internal tests and uncorrected coordinates stay off this page.',
      ...
      'visitor.aboutPublic': 'Thirteen stories are public: Hsinchu beef noodle five, Yangmingshan stay-and-hike, Tokyo tabletop market in Makuhari, a walking elephant in the Nantes shipyard, Fulong: one night, bike Old Caoling, Akiyoshido: seventeen degrees underground, elevator up to the plateau, Ogose: Kuroyamaen fish-and-grill, three waterfalls on the way, Kawazu: seven waterfalls on the mountain side, the coast another half day, Tateyama Murodo: a plateau at two thousand four hundred and fifty metres, Inatori Akao: one night, looking at the fishing port and Sagami Bay, Switzerland: cable cars all the way to the Matterhorn, Scandinavia: seven days strung together by ferry, and three powder picks in Japan: Yuzawa, Rusutsu, Furano.',
